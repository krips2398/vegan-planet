...
# This is the final dataframe needed for the entire map
  ...
  main <- ggplot(tidycars, aes(x = fct_reorder(key, -miss2, sum), y = fct_rev(id),
    ...
    theme(legend.position = "none", axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1, size = 20), axis.text.y = element_text(vjust = 0.5, hjust=1, size = 20), axis.title.y
...
* 100% of the rows within these variables also appear to be missing.
